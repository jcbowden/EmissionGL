...
function TPCResults.ClearResultsData(singleOrDouble : integer; messageStr : string) : boolean ;
Var
  msgRes : Word ;
begin
...
function TPCResults.DoPCAFirst(xDataIn : TMatrix; PCs_wanted_in : integer; meanCentre, colStandardise : boolean) : string ;
var
  tPCAObject  : TPCA ;
begin
  result := '' ;
...
function TPCResults.CreatePCRModelSecond( xDataIn, yDataIn : TMatrix; pcRange : string)  : string ;
var
